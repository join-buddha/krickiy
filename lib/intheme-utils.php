...
if ( ! function_exists( 'it_select_tag' ) ) {

    function it_select_tag( $attrs = array(), $options = array(), $active = false ) {

        echo '<select ' . it_array_to_attributes( $attrs ) . '>' . it_array_to_select_options( $options, $active ) . '</select>';
...
if ( ! function_exists( 'it_key_is_truthey' ) ) {

    function it_key_is_truthey( $array, $key ) {
