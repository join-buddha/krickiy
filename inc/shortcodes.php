...
function fluxus_shortcode_service( $args = null, $content = null, $code = null ) {
    ...
    if ( 'services' == $code ) {
        ...
        if ( isset( $args['columns'] ) && in_array( $args['columns'], array( 2, 3, 4, 5, 6 ) ) ) {
...
function fluxus_shortcode_button( $args = null, $content = null ) {
    ...
    $style  = isset( $args['css_style'] ) ? ' style="' . esc_attr( $args['css_style'] ) . '"' : '';
...
function fluxus_shortcode_tabs( $args = null, $content = null, $code = '' ) {
    ...
    if ( $code == 'tabs' ) {
        ...
        $html = '<div class="tab' . $css . '">' . do_shortcode( $content ) . '</div>';
