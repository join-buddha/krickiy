...
class Fluxus_Widget_Project_Types extends WP_Widget {
    ...
    function Fluxus_Widget_Project_Types() {
        ...
        parent::__construct( 'fluxus-project-types-widget', __( 'Project Types', 'fluxus' ), $widget_ops, $control_ops );
    }
        ...
        if ( is_single() ) :
                ...
                <ul><?php
                    foreach ( $tags as $tag ) : ?>
                        <li class="project-type-<?php echo $tag->term_id; ?>">
                            <a href="<?php echo get_term_link( $tag, 'fluxus-project-type' ); ?>">
                                <b class="hash">#</b>
                                <?php echo $tag->name; ?>
                            </a>
                        </li><?php
            ...
            if ( $active_tag_slug ) {
                ...
                if ( ! empty( $active_tag->description ) ) {
                    echo $args['before_widget'];
                    echo $args['before_title'] . $active_tag->name . $args['after_title'];
                    echo '<div class="textwidget">' . nl2br( $active_tag->description ) . '</div>';
                    echo $args['after_widget'];
                }
            }
            ...
            // Show all tags
                ...
                $all_link = esc_url( fluxus_get_default_portfolio_permalink() );
            ...
            <ul>
                ...
                foreach ( $tags as $tag ) :
                    ...
                    <li class="project-type-<?php echo $tag->term_id; ?>">
                        <a<?php echo $class; ?> href="<?php echo esc_url( get_term_link( $tag, 'fluxus-project-type' ) ); ?>">
                            <b class="hash">#</b>
                            <?php echo $tag->name; ?>
                        </a>
                    </li><?php
